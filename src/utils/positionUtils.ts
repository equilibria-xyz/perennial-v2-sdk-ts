...
export function calcEstExecutionPrice({
  ...
  const priceImpact = tradeFeeData.tradeImpact.impactPerPosition

  const priceImpactPercentage = notional !== 0n ? Big6Math.div(tradeFeeData.tradeImpact.total, notional) : 0n
